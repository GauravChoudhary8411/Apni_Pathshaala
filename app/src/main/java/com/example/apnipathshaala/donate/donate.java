...
import com.example.apnipathshaala.dfragments.dSearchFragment;
import com.example.apnipathshaala.dfragments.dpostfragment;
...
public class donate extends AppCompatActivity {
    ...
    private void setupViewPager() {
        ...
        mPagerAdapter.addFragment(new dSearchFragment());
        mPagerAdapter.addFragment(new dpostfragment());
    ...
    private void verifyPermissions() {
        ...
        if (ContextCompat.checkSelfPermission(this.getApplicationContext(),
            ...
            ActivityCompat.requestPermissions(com.example.apnipathshaala.donate.donate.this,
                    permissions,
                    REQUEST_CODE);
        }
    }
